...
function obtenerRutaImagen($urlImagen): string
{
    ...
    if (strpos($urlImagen, 'backend/') === 0) {
        return $urlImagen;
    }

    if (strpos($urlImagen, 'Patch_BolsaTrabajo/') === 0) {
        return $urlImagen;
    }

    return
        'backend/modulo/Patch_BolsaTrabajo/'
        . 'uploads/img_vacante/'
        . ltrim($urlImagen, '/');
}
    ...
    if (!$stmt) {
        ...
        if (!$stmt->execute()) {
            ...
            if (!$vacante) {
                ...
                $error =
                    'La vacante que buscas no está disponible '
...
if ($vacante) {
    ...
    $descripcion = campoVacante(
        $vacante['descripcion']
    );

    $ubicacion = campoVacante(
        $vacante['ubicacion']
    );

    $tipoJornada = campoVacante(
        $vacante['tipo_jornada']
    );

    $modalidad = campoVacante(
        $vacante['modalidad']
    );

    $oferta = limpiarContenidoRichText(
        $vacante['lo_que_se_ofrece']
    );

    $requisitos = limpiarContenidoRichText(
        $vacante['requisitos']
    );

    $responsabilidades = limpiarContenidoRichText(
        $vacante['responsabilidades']
    );

    $urlImagen = campoVacante(
        $vacante['url_imagen']
    );

    $rutaImagen = obtenerRutaImagen(
        $urlImagen
    );
    ...
    $activo =
        (int)$vacante['activo'] === 1;

    $archivada =
        (int)$vacante['archivada'] === 1;
...
if ($vacante) {
    ...
    if ($descripcion !== '') {
        ...
        $descripcionSEO =
            'Consulta los detalles de la vacante '
            . $titulo
            . ' en Kombitec.';
    }
...
<head>
    ...
    <title>
        ...
        <?php if ($vacante): ?>
            ...
            <?= e($titulo) ?> | Bolsa de Trabajo | Kombitec

        <?php else: ?>

            Vacante no disponible | Bolsa de Trabajo | Kombitec
    ...
    <link
        rel="stylesheet"
        href="css/detalle-vacante.css"
    >

    <!-- =====================================================
         AJUSTE DE TARJETAS SUPERIORES
         Ubicación / Tipo de jornada / Modalidad
         ===================================================== -->

    <style>

        /*
         * Cada elemento se muestra horizontalmente:
         *
         * [ ICONO ]  Título
         *            Valor
         *
         * El icono está dentro de un cuadrado pequeño.
         */
        ...
        /*
         * Cuadrado que contiene el icono.
         */
        ...
        /*
         * SVG perfectamente centrado dentro
         * del cuadrado.
         */
         ...
         * El icono sigue siendo cuadrado y el texto
         * continúa a su derecha.
         */
...
<header class="detalle-header">
    ...
    <nav class="navbar">
        ...
        <div class="menu">
            ...
            <a href="BolsaDeTrabajo.php#vacantes">
                Vacantes
            </a>
...
<?php if ($error): ?>
    ...
    <section class="vacante-error">
        ...
        <a
            ...
            href="BolsaDeTrabajo.php#vacantes"
        >
    ...
    <section class="detalle-hero">
        ...
        <div class="detalle-hero-contenido">
            ...
            <?php else: ?>
                ...
                <div
                    class="detalle-descripcion detalle-descripcion-vacia"
                >
    ...
    <div class="detalle-grid">
        ...
        <div class="detalle-principal">
            ...
            <?php if ($rutaImagen !== ''): ?>
                ...
                <section class="bloque-imagen">
                    ...
                    <div class="imagen-contenedor">
                        ...
                        <img
                            src="<?= e($rutaImagen) ?>"
                            alt="Imagen de la vacante <?= e($titulo) ?>"
                            class="imagen-vacante"
                        >
            ...
            <?php if (!$soloImagen): ?>
                        ...
                        <div class="titulo-bloque">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <path
                                        d="M12 3l2.2 5.1L20 9l-4 3.8 1.1 5.6L12 15.7 6.9 18.4 8 12.8 4 9l5.8-.9L12 3Z"
                                        stroke="currentColor"
                                        stroke-width="1.7"
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                ...
                <?php if (
                    ...
                    <section
                        class="bloque-detalle bloque-sin-contenido"
                    >

                        <div
                            class="icono-sin-contenido"
                            aria-hidden="true"
                        >
        ...
        <aside class="detalle-lateral">
            ...
            <section class="card-postulacion">
                ...
                <p>
                    Si deseas participar en el proceso
                    de selección, puedes enviarnos tu CV.
                </p>
                ...
                <button
                    ...
                    id="abrirModalPostulacion"
                    data-vacante-token="<?= e($token) ?>"
                    data-vacante-titulo="<?= e($titulo) ?>"
                >

                    <span
                        class="boton-postular-icono"
                        aria-hidden="true"
                    >
                ...
                <span class="texto-postulacion">
                    Al seleccionar esta opción
                    podrás postularte a esta vacante.
                </span>
...
<?php if (!$error): ?>
    ...
    /*
     * El contenido completo del modal se encuentra
     * separado en su propio módulo.
     *
     * Archivo:
     * public_html/partials/modal/modal_postulacion.php
     */

    require_once __DIR__ . "/partials/modal/modal_postulacion.php";
...
>
    ...
    <div class="footer-contenido">
        ...
        <a href="mailto:christianchavez394@gmail.com">
            Contacto
        </a>
